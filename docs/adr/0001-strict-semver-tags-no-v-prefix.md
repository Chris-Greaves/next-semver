...
> Superseded by [ADR 0003](./0003-release-tags-accept-optional-v-prefix.md): the `v`-prefix restriction below no longer holds. The pre-release/build-metadata restriction is unchanged.
